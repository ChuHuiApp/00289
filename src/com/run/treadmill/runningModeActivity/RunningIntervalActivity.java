...
import com.run.treadmill.runningParamManager.RunningParamInterval;
...
public class RunningIntervalActivity extends BaseActivity implements OnClickListener, 
	TimerCallBack, ParamRefreshTimerCallBack, HrBeatTimerCallBack {

	private String TAG = "RunningIntervalActivity";
	...
	private RunningParamInterval mRunningParam = null;
	...
	public void initParamDataAndRunTimer() {
		mRunningParam = new RunningParamInterval(mContext);
...
//    	super.onBackPressed();
	...
	private void releaseQuitProc() {
		...
		MyUtils.animLeftFinishActivity(RunningIntervalActivity.this, intent);
	}
