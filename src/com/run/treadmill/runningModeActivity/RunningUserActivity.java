...
import com.run.treadmill.runningParamManager.RunningParamUser;
...
public class RunningUserActivity extends BaseActivity implements OnClickListener, 
	TimerCallBack, ParamRefreshTimerCallBack, HrBeatTimerCallBack {

	private String TAG = "RunningUserActivity";
	...
	private RunningParamUser mRunningParam = null;
	...
	public void initParamDataAndRunTimer() {
		mRunningParam = new RunningParamUser(mContext);
...
//    	super.onBackPressed();
	...
	private void releaseQuitProc() {
		...
		MyUtils.animLeftFinishActivity(RunningUserActivity.this, intent);
	}
