...
import com.run.treadmill.runningParamManager.RunningParamHill;
...
public class RunningHillActivity extends BaseActivity implements OnClickListener, 
	TimerCallBack, ParamRefreshTimerCallBack, HrBeatTimerCallBack {

	private String TAG = "RunningHillActivity";
	...
	private RunningParamHill mRunningParam = null;
	...
	public void initParamDataAndRunTimer() {
		mRunningParam = new RunningParamHill(mContext);
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				...
				case MSG_REFRESH_PARAM_VALUE:
					...
					if( mRunningParam.isCoolDownPage ) {
						Log.d(TAG,"==========MSG_REFRESH_PARAM_VALUE=============");
...
//    	super.onBackPressed();
	...
	private void releaseQuitProc() {
		...
		MyUtils.animLeftFinishActivity(RunningHillActivity.this, intent);
	}
