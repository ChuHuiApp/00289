...
import com.run.treadmill.runningModeActivity.RunningHillActivity;
...
public class HillModeSettingActivity extends BaseActivity implements OnClickListener,
	SafeTimerCallBack  {
	
	private String TAG = "HillSettingActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hill_setting);
		mContext = this;
		...
		editText_age.setOnClickListener(this);
		...
		switch (arg0.getId()) {
			...
			case R.id.btn_start:
				...
				UserInfoManager.getInstance().setTargetTime(Integer.parseInt(editText_time.getText().toString()),
						UserInfoManager.getInstance().getRunMode());
//				UserInfoManager.getInstance().setTargetTime(2, UserInfoManager.getInstance().getRunMode());	//设置时间为分钟
				Intent intent = new Intent(mContext, RunningHillActivity.class);
