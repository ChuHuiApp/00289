...
import com.run.treadmill.runningModeActivity.RunningFitnessActivity;
...
public class FitnessTestModeSettingActivity extends BaseActivity implements OnClickListener
	, SafeTimerCallBack {
	
	private String TAG = "FitnessTestModeSettingActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fitnesstest_setting);
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
			...
			case R.id.btn_start:
				...
				UserInfoManager.getInstance().setTargetTime(0, UserInfoManager.getInstance().getRunMode());//设置时间为分钟
				Intent intent = new Intent(mContext, RunningFitnessActivity.class);
			...
			case R.id.btn_male:
				...
				UserInfoManager.getInstance().setSex(CTConstant.GENDER_BOY);
				break;
			case R.id.btn_female:
				...
				UserInfoManager.getInstance().setSex(CTConstant.GENDER_GIRL);
				break;
